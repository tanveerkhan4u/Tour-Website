...
const Tour3 = ({ setShowModal }) => {
  return (
    ...
    <div>
      ...
      <div
        style={{
          backgroundImage: `url(https://images.unsplash.com/photo-1674501021977-f12fbde5f11c?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fG1leGljbyUyMGNpdHl8ZW58MHx8MHx8fDA%3D)`,
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold  rounded">
            Welcome to Anachorague to qutiou
          </h1>
        </div>
      </div>
